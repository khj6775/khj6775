...
print(x_augmented.shape, y_augmented.shape)     # (40000, 32, 32) (40000,)
...
print(x_augmented.shape)     # (40000, 32, 32, 3) 변환된 데이터
...
path = './_save/keras49/03_cifar10/'
filename = '{epoch:04d}-{val_loss:.4f}.hdf5' 
filepath = "".join([path, 'k49_cifar10_', date, '_', filename])   
#####################################
...
# loss : 0.9846059679985046
# acc : 0.6676
# accuracy_score : 0.5504
