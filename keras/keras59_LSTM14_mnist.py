...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, LSTM, Reshape
import time
...
model.add(Conv2D(64, (3,3), activation='relu', strides=1,input_shape=(28, 28, 1)))   # 데이터의 개수(n장)는 input_shape 에서 생략, 3차원 가로세로컬러  27,27,10
...
model.summary()
# exit()
model.add(Reshape(target_shape=(24*24, 32) ))

model.add(LSTM(units=32, input_shape=(24*24,32),return_sequences=True))
model.add(LSTM(32))
...
# loss : 0.12108983099460602
# acc : 0.9762
# r2 score : 0.9570546577882773
# acc_score : 0.97425

# LSTM
# loss : 2.117851734161377
# acc : 0.2177
# r2 score : 0.05201609480873511