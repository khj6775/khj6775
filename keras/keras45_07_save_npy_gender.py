...
# path_train = './_data/_save_img/06_men_women'      ##########  상위폴더에서 지정  ##########
...
np.save(np_path + 'keras45_07_gender_x_train1.npy', arr=xy_train[0][0])
np.save(np_path + 'keras45_07_gender_y_train1.npy', arr=xy_train[0][1])
