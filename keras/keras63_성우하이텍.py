...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test, y_train, y_test = train_test_split(x1_datasets, x2_datasets, x3_datasets, y,
                                                                         train_size=0.8, random_state= 722)

print(x1_train.shape, )
print(x2_train.shape, )
print(x3_train.shape,)
# y_train = y_train.reshape(-1,5*5,16)
print(y_train.shape,)
# exit()

#2-1. 모델
input1 = Input(shape=(5,8))
dense1 = Conv1D(filters=10, kernel_size=2,padding='same')(input1)
dense2 = Conv1D(10, 2,padding='same')(dense1)
# dense3 = (Flatten())(dense1)
...
#2-2. 모델
input11 = Input(shape=(5,8))
dense11 = Conv1D(filters=10, kernel_size=2, padding='same')(input11)
dense12 = Conv1D(10, 2,padding='same')(dense11)
...
dense21 = Conv1D(filters=10, kernel_size=2 , padding='same')(input2)
dense22 = Conv1D(10, 2,padding='same')(dense21)
# dense32 = (Flatten())(dense22)
dense33 = Dense(32, activation='relu', name='bit210')(dense22)
...
y_pre = model.predict([x1_pred, x2_pred, x3_pred])
