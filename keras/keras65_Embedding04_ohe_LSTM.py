...
# exit()
pad_x = to_categorical(pad_x, num_classes=31)


x_pred_ohe = to_categorical(pred_x, num_classes=31)
pred_x = x_pred_ohe.reshape(1,5,31)

print(x_pred_ohe)
print(x_pred_ohe.shape)

# exit()

# print(pad_x.shape)

# pad_x = pad_x.reshape(1,15,31)
# x_pred_ohe = x_pred_ohe.reshape(1,15,31)
...
############### DNN 맹그러봐 ################
model = Sequential()
model.add(LSTM(units=16, input_shape=(5,31)))
