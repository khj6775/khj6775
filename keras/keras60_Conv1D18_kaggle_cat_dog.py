...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling2D, BatchNormalization, Reshape, LSTM, Conv1D, Flatten
import time
...
# model.add(Reshape(target_shape=(12*12, 32) ))

# model.add(LSTM(units=32, input_shape=(12*12,32),return_sequences=True))
# model.add(LSTM(32))
