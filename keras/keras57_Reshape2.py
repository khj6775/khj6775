...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, Reshape, MaxPooling2D, LSTM
import time
...
model.add(Reshape(target_shape=(13*13, 64 ) ))       # (n, 28, 28, 1)
...
model.add(Reshape(target_shape=(8,8,1 ) ))       # (n, 28, 28, 1)

# model.summary()
# exit()

model.add(Conv2D(5, (2,2), ))   # 7, 7, 5
