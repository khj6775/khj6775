...
x_train = np.load(np_path + 'keras45_01_brain_x_train.npy')
y_train = np.load(np_path + 'keras45_01_brain_y_train.npy')
x_test = np.load(np_path + 'keras45_01_brain_x_test.npy')
y_test = np.load(np_path + 'keras45_01_brain_y_test.npy')
...
# path = './_save/keras45/01_save_npy_brain/'
# filename = '{epoch:04d}-{val_loss:.4f}.hdf5' 
# filepath = "".join([path, 'k45_brain_', date, '_', filename])   
# #####################################
...
model = load_model('C:/AI5/_save/keras45/01_save_npy_brain/k45_brain_0805_1215_0077-0.0828.hdf5')
