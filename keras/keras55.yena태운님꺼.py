...
x_test1 = x[-1].reshape(-1,144,13)  # 맨 마지막 x 남기기
# print(x)
...
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.2, random_state=369369)
...
submit.to_csv(path + "jena_김호정_0811_1849.csv", index=False)
#0809_1600
# RMSE :  1.3556092750115778

# k55_yena_0809_1742_0279-0.1397.hdf5
