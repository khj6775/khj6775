...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling2D, BatchNormalization, LSTM, Reshape
import time
...
# start = time.time()
hist = model.fit(x_train, y_train, epochs=1, batch_size=8,
