...
print(x_augmented.shape, y_augmented.shape)     # (50000, 32, 32) (50000,)

x_augmented = x_augmented.reshape(
    x_augmented.shape[0],   # 50000
...
print(x_augmented.shape)     # (50000, 32, 32, 3) 변환된 데이터
...
model.add(Conv2D(64, (3,3), 
                 ...
                 input_shape=(32, 32, 3)))   # 데이터의 개수(n장)는 input_shape 에서 생략, 3차원 가로세로컬러  27,27,10
...
path = './_save/keras49/04_cifar100/'
filename = '{epoch:04d}-{val_loss:.4f}.hdf5' 
filepath = "".join([path, 'k49_cifar100_', date, '_', filename])   
#####################################
...
# loss : 2.896639585494995
# acc : 0.3001
# accuracy_score : 0.1434
