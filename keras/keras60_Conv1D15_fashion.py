...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, Reshape, LSTM, Conv1D, Flatten
import time
...
model.add(Conv1D(filters=64, kernel_size=2, input_shape=(28,28, 1)))
...
start = time.time()
hist = model.fit(x_train, y_train, epochs=100, batch_size=1024,
          verbose=1,
...
# LSTM
# loss : 1.691590666770935
# acc : 0.38

# Conv1D
# loss : 0.689397931098938
# acc : 0.85