...
model = HalvingGridSearchCV(XGBClassifier(
                           ...
                           random_state=333,
                           factor=3,  # default=3
                           min_resources=50,            # 너무 작게 자르면 클라스가 다 못 들어가서 에러가 날 수 있다.
                           max_resources=1437,
...
# n_iterations: 4           총 4번 돌리겠다
# n_required_iterations: 5     
# n_possible_iterations: 4     
# min_resources_: 100       
# max_resources_: 1437       행의 수
# aggressive_elimination: False    
# factor: 2

# iter: 0             첫번째 이터 돌리기
# n_candidates: 25    5 * 5
# n_resources: 100    min_resources_: 100

# iter: 1             두번째 이터 돌리기
# n_candidates: 13    factor 의 수만큼 나눔
# n_resources: 200    factor 의 수만큼 곱하기

# iter: 2             세번째 이터 돌리기
# n_candidates: 7     factor 의 수만큼 나눔 
# n_resources: 400    factor 의 수만큼 곱하기

# iter: 3             네번째 이터 돌리기
# n_candidates: 4     factor 의 수만큼 나눔 
# n_resources: 800    factor 의 수만큼 곱하기

# HalvingGridSearchCV = 분할해서 그리드 서치 한다.


# 최적의 파라미터 :  {'learning_rate': 0.2, 'max_depth': 3}
# best_score :  0.9448270440251573
