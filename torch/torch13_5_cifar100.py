...
from torchvision.datasets import CIFAR100   # vision = image
...
test_dataset = CIFAR100(path, train=True, download=True)
...
# 최종 loss :  (3.345933017712408, 0.19839651311580295)
# acc_score : 0.17922